...
import SwapPage from "../../app/trade/swap/page";
...
vi.mock("@/components/features/common/Header", () => ({
...
vi.mock("@/components/features/common/BackgroundTokens", () => ({
  BackgroundTokens: () => <div data-testid="background-tokens">Background</div>,
}));

// Mock TokenSelector component
vi.mock("@/components/features/trade/TokenSelector", () => ({
...
describe("SwapPage Component", () => {
  ...
  it("displays swap interface elements", () => {
    ...
    expect(
      screen.getByText("Trade any combination of tokens with the best rates and lowest fees."),
    ).toBeInTheDocument();
  });
