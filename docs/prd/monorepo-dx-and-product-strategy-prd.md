...
| Interface (Web) | Next.js 15 + React 19 app with wallet support | `apps/web` (formerly `interface/web`) | ⚠️ | On unstable Next/Tailwind versions, no TanStack Router, no OpenNext deploy path, lacks design-system extraction and e2e coverage. |
