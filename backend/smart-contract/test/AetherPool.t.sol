...
contract AetherPoolTest is Test {
    ...
    function setUp() public {
        ...
        feeRegistry = new FeeRegistry(); // Deploy FeeRegistry with zero-argument constructor
        feeRegistry.addFeeConfiguration(3000, 60); // Add 0.3% fee tier
        // Pass owner, feeRegistry, and placeholder creationCodeHash
        factory = new AetherFactory(address(this), address(feeRegistry)); // Removed bytecode argument
    ...
    */
    ...
    function testRevertOnInsufficientLiquidityBurned() public {
    ...
    function testRevertOnInsufficientOutputAmount() public {
        ...
        // --- Debug Logging ---
        console2.log("--- testRevertOnInsufficientOutputAmount ---");
    ...
    function testRevertOnInvalidTokenIn() public {
        vm.startPrank(alice);
    ...
    function testStaticCallTokens() public {
        console2.log("--- testStaticCallTokens ---");
